{ ... }:
{
  ...
  # otter's Zen profile id. read by rice.zen (its user.js lands here) and by
  # zen-tabgrouper once a signed XPI exists. the id differs per machine.
  rice.zen.profilePath = "Library/Application Support/zen/Profiles/c6bgtaur.Default (release)";
