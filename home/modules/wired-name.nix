...
let
  ...
  # lives in), cuttlefish the nixos box (the protocol underneath). unknown hosts fall
  # back to the uppercased real hostname so a new box still reads as itself, loudly.
  wiredNames = {
    otter = "NAVI";
    coral = "CYBERIA";
    cuttlefish = "PROTOCOL7";
  };
in
{
